        ...
        <>
            <div className="seventhpage">
                <div className="customer-heading">
                    <p>Hear From Our <span>Customers</span></p>
                </div>
                <section>
                        ...
                        <div className="swiper-wrapper content">
                            <div className="swiper-slide card-slide">
                                <div className="card-content">
                                    ...
                                    <div className="customer-message">
                                        <p className="text-black">“Have been working with Adshustle since November. Have
                                            good communication with AM, everything solves very quick,
                                            we find many mutual points to boost our profit from both
                                            of sides. Appreciate this partner a lot. ”</p>
                                    </div>
                            ...
                            <div className="swiper-slide card-slide">
                                <div className="card-content">
                                    ...
                                    <div className="customer-message">
                                        <p className="text-black">“It's a pleasure to work with Adshustle who is really
                                            professional and has good performance for our campaigns”</p>
                                    </div>
                                    <div className="rating">
                                        <i className="fas fa-star"></i>
                                        <i className="fas fa-star"></i>
                            ...
                            <div className="swiper-slide card-slide">
                                <div className="card-content">
                                    ...
                                    <div className="customer-message">
                                        <p className="text-black">“We are thankful that Adshulte went out of their way each
                            ...
                            <div className="swiper-slide card-slide">
                                <div className="card-content">
                                    ...
                                    <div className="customer-message">
                                        <p className="text-black">“High standard and
                                            excellent quality of work.
                                            They helped my business
                                            grow in digital.”</p>
                                    </div>
                                    <div className="rating">
                                        <i className="fas fa-star"></i>
            ...
            {/* <div className="seventhpage">
                ...
                <div className="container customer-card">
                    <div className="row row-cols-sm-1 row-cols-md-2 row-cols-lg-4 customers">
                        {CustomerData.map((value, index) => (
                            <div className="col-md customer" key={index}>
                                <div className="customer-img">
                                    <img src={value.img} alt="" />
                                </div>
                                <div className="customer-message">
                                    <p className="text-black">{value.message}</p>
                                </div>
                                <div className="rating">
                                    <img src={rating} alt="" />
                                </div>
